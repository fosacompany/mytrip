...
var data = {
    ...
    datasets: [{
        ...
        data: [65, 59, 4, 81, 56, 55, 40, 65, 59, 4, 81, 56]
    }, {
        label: "My First dataset",
        //new option, barline will default to bar as that what is used to create the scale
        type: "bar",
        ...
        pointHighlightFill: "#fff",
        pointHighlightStroke: "rgba(220,220,220,1)",
        data: [32, 25, 33, 88, 12, 92, 33, 32, 25, 33, 88, 12]
    }]
};
...
//some manipulation to test remove and add data still work
//myMultiLineBarChart.removeData();
//myMultiLineBarChart.addData([1,2,33], "some data");